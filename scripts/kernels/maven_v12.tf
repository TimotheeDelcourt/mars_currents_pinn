...
-------------------------------------------------------------------------------
   ...
   Version 0.12 -- July 28, 2025 -- David Mitchell, SSL-UCB
                                    Matt Barnes, NAIF

      Added the MAVEN_MARS_ENR/-202931 dynamic frame.
        (ENR = East-North-Radial)

      Updated description of MAVEN_SUN_RTN/-202921.

      Updated typos in frame summary table.
...
-------------------------------------------------------------------------------
   ...
   ------------------
      ...
      MAVEN_SWEA              rel.to SPACECRAFT    CK             -202130
...
Sun MAVEN Radial-Tangential-Normal Frame
   ...
   The Sun MAVEN Radial-Tangential-Normal frame is defined as follows:
      ...
      -  +Z axis is constrained towards Solar North so that
         Solar North is in the MAVEN_SUN_RTN Z-X plane and the dot
         product of MAVEN_SUN_RTN +Z and Solar North is positive; 
