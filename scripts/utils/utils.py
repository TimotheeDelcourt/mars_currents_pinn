...
def fibonacci_sphere(samples,alt,plot=0):
    ...
    _,colat, lon = cartesian_to_spherical_torch(tensor[:,0], tensor[:,1], tensor[:,2])
...
try:
    ...
    print("imageio.v3 not found, img2scalar_nocmap and img2scalar_cmap functions will not work.")
